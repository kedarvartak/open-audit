...
### Known Limitations
- Live location tracking requires HTTPS in production
- Push notifications require user permission grant
- Some features require geolocation permissions

### Security Considerations
- JWT tokens stored in localStorage (consider httpOnly cookies for production)
- API keys are exposed in client-side code (use appropriate API restrictions)
- Environment variables embedded at build time (never commit .env files)

---

## License

This project is proprietary software developed for GDG VIT Pune Hackathon.
